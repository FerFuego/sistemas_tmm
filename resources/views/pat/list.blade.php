...
@section('content')
	@if ($medidas != '[]')
	    ...
	    <h3 class="text-uppercase">LISTADO DE PAT</h3>
		    ...
		    <div class="row">
		    	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		    		<div class="white-box">
				            	...
				            	@foreach($medidas as $m)
				            		@if($s->id === $m->idbranch_office)
						            	<tr>
						            		...
						            		<td class="text-center">
						            			<a href="{!! route('usuario.sucursal.show', [$user->id, $s->id,'pat', $m->id]); !!}" class="fa-link-tmm text-merge"><i class="icon-eye"></i></a>
					    ...
					    @else
				        	<p class="text-uppercase mt-40">NO EXISTEN MEDICIONES DE PUESTA A TIERRA </p>
				        @endif
		    		</div>
		    	</div>
		    </div>    

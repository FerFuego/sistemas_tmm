...
@section('title-section','CONTINUIDAD')
              ...
              <table class="table pat-table table-bordered text-center">
                <thead>
                  <tr>
                    ...
                    <th class="text-center">Última Continuidad</th>
                    ...
                    <tr>
                        ...
                        <td> 
                            @foreach($vigencia as $v)
                              @if($v['id'] == $m->id)
                                <span class="{{ $v['class'] }}" style="width: auto!important;">{{ $v['vigencia'] }}</span>
                              @endif
                            @endforeach
                        </td>
                        <td>

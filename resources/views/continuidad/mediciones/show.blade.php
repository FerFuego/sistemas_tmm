...
@section('title-section','MEDICIÓN DE CONTINUIDAD')
            ...
            <table class="table text-left table-bordered table-striped">
               <tr>
                ...
                <tr>
                    ...
                    <td class="b-l-none text-left">{{ $medida->instrument }}</td>
               </tr>
            </table>
          </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="white-box">
                        @if($value->image_1)
                            <a href="{{ asset('images/catalog/'.$value->image_1) }}" data-lightbox="image-1" data-title="Imagen Continuidad"><img src="{{ asset('images/catalog/'.$value->image_1) }}" class="img-responsive"></a>
                        @else
            ...
            <div class="white-box">
                ...
                <table class="table table-bordered table-striped text-center">
                    <tbody>
                        <tr>
                            <td><b>Punto</b></td>
                            <td class="text-center"><b>Valor en Ω</b></td>
                            <td class="text-left"><b>Observaciones</b></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="width-mas-tmm">
                                ...
                                <div class="mini-table-med-show">
                                    <div class="col-mini-1">@if(isset($desc[3]) && !is_null($desc[3])) {{ $desc[3] }} @else {{ $desc[0] }} Ω @endif</div>

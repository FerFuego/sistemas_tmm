...
@section('content')
  @if ($medidas != '[]')
    ...
    <h3 class="text-uppercase">LISTADO DE CONTINUIDAD</h3>
                  ...
                  @foreach($medidas as $m)
                    @if($s->id === $m->idbranch_office)
                      <tr>
                        ...
                        <td class="text-center">
                          <a href="{!! route('usuario.sucursal.show', [$user->id, $s->id,'continuidad', $m->id]); !!}" class="fa-link-tmm text-merge"><i class="icon-eye"></i></a>

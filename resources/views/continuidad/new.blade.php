...
@section('title-section','NUEVA MEDICION DE CONTINUIDAD')
	    ...
	    <div class="white-box">
	        ...
	        <div class="row">
	    		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-3">
	          	...
	          	<div class="col-xs-12 col-sm-12 col-md-12 buttons  col-lg-9 text-xs-center text-sm-center text-md-center text-lg-right">
	    ...
	    <div class="row">
		    ...
		    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
		        <div class="white-box">
		            ...
		            <hr>
		            <table id="tblprod" class="table table-border-none style-table-abm">
		            	<tr></tr>
	            		<tr>
	            			<td class="width-min-tmm">Punto 1</td>
		            ...
		            <div class="row">
		            	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-right">
		            		<button id="btnadd" class="btn btn-default btn-custom-tmm btn-custom-tmm-light">Agregar Punto</button>
		            	</div>
		            </div>
		        </div>
		    </div>
...
@section('javascript')
	...
	<script type="text/javascript">
		...
		function verifyValue(val,id){
			//verifica los niveles de continuidad en los puntos
			//y los compara con los rangos preestablecidos
			var res = id.split("#");
			var data = '<?php if(!empty($rangos_valores)) echo $rangos_valores; ?>';
	        ...
	        if(data == '[]'){
		    	alert('Primero debe cargar los valores de rangos de continuidad.');
		    	document.getElementById("guard_value").disabled = true;
		    	document.getElementById("nuevo").disabled = true;
		    	return
		    }
		    if(isNaN(val)){
		    	//Valor alfanumerico de continuidad

            ...
            <div style="width:230px; display:inline-block; vertical-align: top; padding: 15px 10px 20px 0;">
                <table class="table table-bordered text-center" style="border-collapse: collapse;">
                    ...
                    <tr>
                        ...
                        <td class="text-left">{{$value->sector }}</td>
                    </tr>
                </table><br>
                @if($value->image_1)
                    ...
                    <table class="table table-bordered text-center" style="border-collapse: collapse;">
                        <tbody>
                            <tr>
                                ...
                                <td style="border-bottom:1px solid #eee;"><b>Valor en ohm</b></td>
                            ...
                            <tr>
                                ...
                                <td class="med-min" style="text-align: left;border-bottom:1px solid #eee;padding-top: 15px;">
                                    @if($desc[2] == 'RANGO_1')
                                        ...
                                        @if(isset($desc[3]) && !is_null($desc[3])) {{ $desc[3] }} @else {{ $desc[0] }} ohm @endif
                                        </p>

...
@section('title-section','MEDICION DE DIFERENCIALES')

@section('breadcrumbs')
  <ol class="breadcrumb">
    <li><a href="{{ url('usuarios/todos') }}">usuarios</a></li>
    <li><a href="{{ url('usuarios/'.$user->id.'/ver') }}">{{ $user->name}}</a></li>
    <li><a href="{{ url('usuario/'.$user->id.'/'.$medida->type.'/listado') }}">Diferenciales</a></li>
            ...
            <div class="white-box">
                <table class="table table-bordered text-center">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="b-r-none">
                      <a href=""  data-toggle="modal" data-target="#Modal_certificado" class="text-merge" style="font-weight: 400;line-height: 2.5;">AGREGAR NUEVO ADJUNTO</a></td>
                      <td class="b-l-none text-center"><a href="" data-toggle="modal" data-target="#Modal_certificado"><i class="icon-plus" style="color:#ba0975;font-size:30px;" aria-hidden="true"></i></a></td>
